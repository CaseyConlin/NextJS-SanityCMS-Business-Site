    ...
    >
      ...
      >
        ...
        <MWHeading
          ...
          component={"h2"}
          text={"About Us"}
          styleProps={{ textAlign: "left", alignSelf: "flex-start" }}
        ></MWHeading>
        <Typography variant="body1" py={1}>
          With over 50 years of combined experience, William Staesser and Jeff
          McKelvey lead Macs Works with an unwavering commitment to exceptional
          steel fabrication and craftsmanship. Based in the heart of the Hudson
          Valley, we proudly serve communities across Dutchess, Ulster, Orange,
          Columbia, Greene, Putnam, and Rockland counties. From the bustling
          towns of Poughkeepsie and Kingston to the serene landscapes of
          Rhinebeck and Newburgh, our work can be found enhancing homes,
          businesses, and public spaces throughout the region.
        </Typography>
        <Typography variant="body1" py={1}>
          ...
          that connects communities, we bring the same level of precision, care,
        ...
        <MWHeading
          ...
          component={"h2"}
          text={"Our Work"}
          styleProps={{ textAlign: "left", alignSelf: "flex-start", pt: 5 }}
        ></MWHeading>
        <Typography variant="body1" py={1}>
        ...
        <Typography variant="body1" py={1}>
          ...
          upgrading a historic property in Hudson, or constructing a commercial
          space in Middletown.
        </Typography>
        <Typography variant="body1" py={1}>
